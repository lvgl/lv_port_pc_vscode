...
static void guide_tutorial_bg_cont(lv_obj_t* parent)
{
    ...
    lv_label_set_text(title, "LIKKIM App Tutorial");
    ...
    lv_obj_align(label_describe, LV_ALIGN_CENTER, 0, 0);
}


void guide_tutorial_start(void)
{
    p_guide_tutorial = (guide_tutorial_t*)lv_malloc(sizeof(guide_tutorial_t));
