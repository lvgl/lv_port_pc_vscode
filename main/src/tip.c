...
// 函数声明
lv_obj_t * create_tip_button(lv_obj_t * parent, const char * text, lv_coord_t y_offset, lv_color_t text_color);
...
void load_tips_screen() {
    ...
    /* 创建多个按钮 */
    create_tip_button(container, "Tip 1", -90, lv_color_black());
    create_tip_button(container, "Tip 2", -50, lv_color_black());
    create_tip_button(container, "Tip 3", -10, lv_color_black());
    create_tip_button(container, "Tip 4", 30, lv_color_black());
    create_tip_button(container, "Tip 5", 70, lv_color_black());

    /* 创建Back按钮 */
    lv_obj_t * back_btn = create_tip_button(container, "Back", 150, lv_color_black());
